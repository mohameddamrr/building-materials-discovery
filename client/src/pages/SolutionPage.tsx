...
export function SolutionPage() {
  ...
  return (
    <article>
      ...
      <p className="mt-6 rounded-sm bg-amber-50 p-5 font-semibold text-amber-950">We found a curated wall scenario for your choices.</p>
      <p className="mt-4 rounded-sm border border-dashed border-slate-300 p-5 text-slate-600">The interactive wall layers and product recommendations will be added in the next phase.</p>
      <aside className="mt-4 text-sm leading-6 text-slate-600">Recommendations in this prototype illustrate a product-discovery experience. Final system and material selection depends on project-specific technical and regulatory requirements.</aside>
