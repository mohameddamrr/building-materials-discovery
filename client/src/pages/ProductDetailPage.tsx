  ...
  return (
    <article>
      ...
      <div className="mt-7 overflow-hidden rounded-[2rem] bg-white shadow-xl shadow-slate-900/5 lg:grid lg:grid-cols-2">
        <div className="relative min-h-80 bg-slate-900 lg:min-h-[34rem]"><img alt="Representative construction material image" className="absolute inset-0 size-full object-cover" src={productImages[product.slug]} /><div className="absolute inset-0 bg-gradient-to-t from-slate-950/75 to-transparent" /><p className="absolute bottom-6 left-6 rounded-full bg-amber-400 px-3 py-1 text-xs font-black uppercase tracking-[0.16em] text-slate-950">{categoryLabels[product.category]}</p></div>
